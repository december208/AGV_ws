...
"""autogenerated by genpy from agv/targetAction.msg. Do not edit."""
import sys
...
class targetAction(genpy.Message):
  _md5sum = "7f2607c400c3484e25717a6a65ee86bd"
  _type = "agv/targetAction"
...
"""
  ...
  _slot_types = ['agv/targetActionGoal','agv/targetActionResult','agv/targetActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = agv.msg.targetActionGoal()
      if self.action_result is None:
        self.action_result = agv.msg.targetActionResult()
      if self.action_feedback is None:
        self.action_feedback = agv.msg.targetActionFeedback()
    else:
      self.action_goal = agv.msg.targetActionGoal()
      self.action_result = agv.msg.targetActionResult()
      self.action_feedback = agv.msg.targetActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.trigger.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.info.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.progress.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.trigger.data = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.trigger.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.info.data = str[start:end].decode('utf-8')
      else:
        self.action_result.result.info.data = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.progress.data = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.progress.data = str[start:end]
      return self
