...
"""autogenerated by genpy from agv/targetActionResult.msg. Do not edit."""
import sys
...
class targetActionResult(genpy.Message):
  _md5sum = "9d7534c17fe3daf6b2842b2f6bc24bf0"
  _type = "agv/targetActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','agv/targetResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = agv.msg.targetResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = agv.msg.targetResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.info.data = str[start:end].decode('utf-8')
      else:
        self.result.info.data = str[start:end]
      return self
