...
"""autogenerated by genpy from agv/targetActionFeedback.msg. Do not edit."""
import sys
...
class targetActionFeedback(genpy.Message):
  _md5sum = "127cddeeffd87f1f4e2e79e1fd2c100c"
  _type = "agv/targetActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','agv/targetFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = agv.msg.targetFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = agv.msg.targetFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.feedback.progress.data
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.feedback.progress.data = str[start:end].decode('utf-8')
      else:
        self.feedback.progress.data = str[start:end]
      return self
